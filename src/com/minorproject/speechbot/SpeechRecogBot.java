...
//-----------------------------| GUI COMPONENTS |-----------------------------------------//	
		...
		btnInfo.addActionListener(new ActionListener() {
	        ...
	        JOptionPane.showMessageDialog(null, "<html><center><h3>Minor Project on Speech Recognition Bot</h3></center><br/>A Minor Project <br/> research on Speech Recognition Technology <br/>  and Sphinx-4<br/><br/><center><b>Project Members </b></center></br> <center> <b>Jasbin Karki : 14317</b> <br/> <b>Nikesh Sitaula : 14325</b> <br/> <b>Nisha Mahato:14326 </b> </center> </html>");
	            }
	        });
		...
		btnHowToUse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			   JOptionPane.showMessageDialog(null, "<html> <h3> HOW TO USE </h3> Start the application and u are ready to go<br/> Use commands like: <br><i><ul><li>Hey Computer</li><li> Do you have a name?</li><li> Open *Application Name*</li><li>What does the fox say?</li><li> Make me a coffee</li> </ul>for more commands and troubleshooting guide <br/></html>");
			       }
			   });
...
//---------------------------------| Time and System Apps |-------------------------------------//            
		...
		try{
		 ...
		 if(resultText.equalsIgnoreCase("open word"))
			{
				try{
					slnDisp.setText("Opening Microsot Word" ) ;
					pro =new ProcessBuilder("/usr/bin/open", "-a", "Microsoft Word").start();;
					answerToStr = slnDisp.getText();
					textToSpeech=("Say "+"\""+answerToStr+"\"");
					Runtime.getRuntime().exec(textToSpeech);
					TimeUnit.SECONDS.sleep(4);
		 ...
		 if (resultText.equalsIgnoreCase("close word"))
		    {
		        try{
		        slnDisp.setText("Closing Microsoft Word" ) ;
		        pro =new ProcessBuilder("/usr/bin/killall", " -kill-a", "Microsoft Word").start();
		        answerToStr = slnDisp.getText();
				textToSpeech=("Say "+"\""+answerToStr+"\"");
				Runtime.getRuntime().exec(textToSpeech);
				TimeUnit.SECONDS.sleep(4);
